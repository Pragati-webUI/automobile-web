...
<div id="rateandreview" style="margin-top: 145px;">
    <div class="page-content container note-has-grid">
        <ul class="nav nav-pills justify-content-around p-3 bg-white mb-3 rounded-pill align-items-center border border-dark container1">
            <li class="nav-item mb-1">
                <a href="javascript:void(0)" class="nav-link bg-dark text-white rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2 active" id="all-category">
                    <i class="icon-layers mr-1"></i><span class="d-md-block">All Notes</span>
                </a>
            </li>
            <li class="nav-item mb-1">
                <a href="javascript:void(0)" class="nav-link bg-dark text-white rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2" id="note-business"> <i class="icon-briefcase mr-1"></i><span class="d-md-block">Company</span></a>
            </li>
            <li class="nav-item mb-1">
                <a href="javascript:void(0)" class="nav-link bg-dark text-white rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2" id="note-social"> <i class="icon-share-alt mr-1"></i><span class="d-md-block">Products</span></a>
            </li>
            <li class="nav-item mb-1">
                <a href="javascript:void(0)" class="nav-link bg-dark text-white rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2" id="note-important"> <i class="icon-tag mr-1"></i><span class="d-md-block">Mechanic
                        Services</span></a>
            </li>
            <li class="nav-item mb-1">
                <a href="javascript:void(0)" class="nav-link btn-dark rounded-pill d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2" id="add-notes"> <i class="icon-note m-1"></i><span class="d-md-block">Add
                        Notes</span></a>
            </li>
        </ul>
        <div class="tab-content bg-transparent">
            <div id="note-full-container" class="note-has-grid row">
                ...
                <div class="col-md-4 single-note-item all-category note-social" style="">
                    <div class="card card-body">
                        <span class="side-stick"></span>
                        <h5 class="note-title text-truncate w-75 mb-0" data-noteheading="Change a Design">Change a
