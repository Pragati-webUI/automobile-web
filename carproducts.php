        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner text-center">
                    <h1 class="page-title">Car Products</h1>
                    <ul class="page-list">
                        <li><a href="#">Home</a></li>
                ...
                <div class="section-border-image margin-right white-gray">
                    <div class="border-design">
                        ...
                        <div class="we-are-img">
                            <img src="assets/img/service/details-01.png" alt="img">
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-5 offset-lg-1">
                ...
                <div class="common-section-content">
                    ...
                    <div class="section-title padding-bottom-20">
                        <h2 class="heading-02"> Auto Spares Parts</h2>
                    </div>
                    <!--// Section Title End-->
                    <div class="paragraph">
                        <p>
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                ...
                <div class="product-description pl-lg-4">
                    <h4 class="title">Flash Deals Tyre</h4>
                    <!--// Title-->
